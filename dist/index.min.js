    ...
    class WebtorGenerator {
      ...
      push(data) {
        const id = Object(_uuid__WEBPACK_IMPORTED_MODULE_1__.a)(),
          elId = "webtor-" + id,
          dd = Object.assign({}, defaults, data),
        ...
        window.addEventListener("message", function (event) {
          ...
          "object" == typeof d &&
            ...
            d.name == self.INIT
              ...
              : d.name != self.INJECT || injected
              ? "function" == typeof data.on && dd.on(d)
              : ((injected = !0), eval(d.data)));
        });
      }
    }
  ...
  function (e, t, n) {
    ...
    !(function (n) {
      ...
      function R(e) {
        ...
        function o(e) {
          var t = Number(g[C]["max" + e]),
            n = Number(g[C]["min" + e]),
            i = e.toLowerCase(),
            o = Number(R[i]);
          M(C, "Checking " + i + " is in range " + n + "-" + t),
            o < n && ((o = n), M(C, "Set " + i + " to min value")),
            o > t && ((o = t), M(C, "Set " + i + " to max value")),
            (R[i] = "" + o);
        }
        function r(e) {
        ...
        "[iFrameResizerChild]Ready" === P
          ? (function () {
              for (var e in g) L("iFrame requested init", j(e), g[e].iframe, e);
            })()
          : l === ("" + P).substr(0, f) && P.substr(f).split(":")[0] in g
          ? ((w = P.substr(f).split(":")),
            (_ = w[1] ? parseInt(w[1], 10) : 0),
            (O = g[w[0]] && g[w[0]].iframe),
            ...
            (b = R.type in { true: 1, false: 1, undefined: 1 }) &&
              M(C, "Ignoring init message from meta parent page"),
            !b &&
              (function (e) {
                var t = !0;
                return (
                  g[e] ||
                    ((t = !1),
                    x(
                      R.type + " No settings for " + e + ". Message was: " + P
                    )),
                  t
                );
              })(C) &&
              ...
              (p = !0),
              null === R.iframe &&
                (x(C, "IFrame (" + R.id + ") not found"), (p = !1)),
              p &&
                (function () {
                  var t,
                    n = e.origin,
                    i = g[C] && g[C].checkOrigin;
                  if (
                    i &&
                    "" + n != "null" &&
                    !(i.constructor === Array
                      ...
                      : ((t = g[C] && g[C].remoteHost),
                        M(C, "Checking connection is from: " + t),
                        n === t))
                  )
                    throw new Error(
                ...
                (function () {
                  switch (
                    (g[C] && g[C].firstRun && g[C] && (g[C].firstRun = !1),
                    R.type)
                  ) {
                    case "close":
                      k(R.iframe);
                    ...
                    case "pageInfo":
                      a(g[C] && g[C].iframe, C),
                        (function () {
                          ...
                          var n = C;
                          e("Add ", v), g[n] && (g[n].stopPageInfo = t);
                        })();
                      break;
                    case "pageInfoStop":
                      g[C] &&
                        g[C].stopPageInfo &&
                        (g[C].stopPageInfo(), delete g[C].stopPageInfo);
                      break;
                    case "inPageLink":
                      !(function (e) {
                        var t,
              ...
              function e() {
                Object.keys(g).forEach(function (e) {
                  !(function (e) {
                    ...
                    g[e] &&
                      null !== g[e].iframe.offsetParent &&
                      (t("height") || t("width")) &&
                      L("Visibility change", "resize", g[e].iframe, e);
                  })(e);
                });
              }
              function t(t) {
      ...
      function D(e, t, n) {
        n !== t.type && h && !window.jasmine
          ? (M(t.id, "Requesting animation frame"), h(e))
          : e();
      }
        ...
        (i = i || n.id),
          g[i] &&
            (n && "contentWindow" in n && null !== n.contentWindow
              ...
              : x(i, "[" + e + "] IFrame(" + i + ") not found"),
            o &&
              g[i] &&
              g[i].warningTimeout &&
              (g[i].msgTimeout = setTimeout(function () {
                !g[i] ||
                  g[i].loaded ||
                  a ||
                  ((a = !0),
      ...
      function U(e, t) {
        ...
        r in g && "iFrameResizer" in e
          ? x(r, "Ignored iFrame, already setup.")
          : (!(function (t) {
              var i;
              (t = t || {}),
                (g[r] = {
                ...
                (function (e) {
                  for (var t in w)
                    Object.prototype.hasOwnProperty.call(w, t) &&
                      (g[r][t] = Object.prototype.hasOwnProperty.call(e, t)
                        ? e[t]
                        : w[t]);
                })(t),
                g[r] &&
            ...
            (function () {
              switch (
                (M(
                  r,
                  "IFrame scrolling " +
                    (g[r] && g[r].scrolling ? "enabled" : "disabled") +
                    " for " +
                    r
                ),
                (e.style.overflow =
                  !1 === (g[r] && g[r].scrolling) ? "hidden" : "auto"),
                g[r] && g[r].scrolling)
              ) {
                case "omit":
                  break;
            ...
            ("number" != typeof (g[r] && g[r].bodyMargin) &&
              "0" !== (g[r] && g[r].bodyMargin)) ||
              ((g[r].bodyMarginV1 = g[r].bodyMargin),
            ...
            v(e, "load", function () {
              var t, n;
              L("iFrame.onload", i, e, void 0, !0),
                (t = g[r] && g[r].firstRun),
                (n = g[r] && g[r].heightCalculationMethod in p),
                !t && n && F({ iframe: e, height: 0, width: 0, type: "init" });
            }),
            L("init", i, e, void 0, !0),
            g[r] &&
              (g[r].iframe.iFrameResizer = {
                close: k.bind(null, g[r].iframe),
                removeListeners: C.bind(null, g[r].iframe),
                resize: L.bind(null, "Window resize", "resize", g[r].iframe),
                moveToAnchor: function (e) {
                  L("Move to anchor", "moveToAnchor:" + e, g[r].iframe, r);
                },
      ...
      function q(e, t) {
        Object.keys(g).forEach(function (n) {
          (function (e) {
            return (
              g[e] &&
              "parent" === g[e].resizeFrom &&
              g[e].autoResize &&
              !g[e].firstRun
            );
          })(n) && L(e, t, g[n].iframe, n);
        });
      }
      function K() {
        v(window, "message", R),
          ...
          v(document, "visibilitychange", H),
          v(document, "-webkit-visibilitychange", H);
      }
      function J() {
        function e(e, n) {
          n &&
        ...
        return (
          (function () {
            var e,
              t = ["moz", "webkit", "o", "ms"];
            for (e = 0; e < t.length && !h; e += 1)
              h = window[t[e] + "RequestAnimationFrame"];
            h
              ? (h = h.bind(window))
    ...
    !(function (t) {
      if ("undefined" != typeof window) {
        ...
        try {
          ...
          window.addEventListener("test", G, L),
            window.removeEventListener("test", G, L);
        } catch (e) {}
        var j,
          U,
          B,
          ...
          Y = {
            ...
            max: function () {
              return Math.max.apply(null, pe(Y));
            },
            min: function () {
              return Math.min.apply(null, pe(Y));
            },
            grow: function () {
              return Y.max();
            },
          ...
          Q = {
            ...
            max: function () {
              return Math.max.apply(null, pe(Q));
            },
            min: function () {
              return Math.min.apply(null, pe(Q));
            },
          ...
          var n = {
            ...
            reset: function () {
              m
                ...
                : (te("Page size reset by host page"), ve("resetPage"));
            },
            resize: function () {
      ...
      function ie() {
        ...
        !(function () {
          ...
          var t = h.substr(_).split(":");
          (v = t[0]),
            (o = void 0 !== t[1] ? Number(t[1]) : o),
            (s = void 0 !== t[2] ? e(t[2]) : s),
            (w = void 0 !== t[3] ? e(t[3]) : w),
            (g = void 0 !== t[4] ? Number(t[4]) : g),
            (n = void 0 !== t[6] ? e(t[6]) : n),
            (r = t[7]),
            (f = void 0 !== t[8] ? t[8] : f),
            (i = t[9]),
            (d = t[10]),
            (I = void 0 !== t[11] ? Number(t[11]) : I),
            (p.enable = void 0 !== t[12] && e(t[12])),
            (O = void 0 !== t[13] ? t[13] : O),
            (C = void 0 !== t[14] ? t[14] : C);
        })(),
          ...
          (k.parentIFrame = {
            ...
            getPageInfo: function (e) {
              "function" == typeof e
                ? ((A = e), Oe(0, 0, "pageInfo"))
                : ((A = function () {}), Oe(0, 0, "pageInfoStop"));
            },
            moveToAnchor: function (e) {
              p.findTarget(e);
            },
      ...
      function ye(e, t, n, i) {
        x && e in u
          ...
          : (e in { reset: 1, resetPage: 1, init: 1 } ||
              te("Trigger event: " + t),
            "init" === e ? we(e, t, n, i) : X(e, t, n, i));
      }
      function _e() {
        x || ((x = !0), te("Trigger event lock on")),
          clearTimeout(P),
